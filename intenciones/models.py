...
class Intencion(models.Model):
    ...
    lote = models.ForeignKey(Lote, on_delete=models.PROTECT, related_name="intenciones")
    vendedor = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    cliente = models.ForeignKey("clientes.Cliente", on_delete=models.PROTECT, related_name="intenciones")
    estado = models.CharField(max_length=20, choices=Estado.choices, default=Estado.INTERES)
